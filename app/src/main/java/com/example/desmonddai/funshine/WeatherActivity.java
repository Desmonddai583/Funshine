package com.example.desmonddai.funshine;
...
import com.example.desmonddai.funshine.model.DailyWeatherReport;
...
public class WeatherActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherImgBig = (ImageView)findViewById(R.id.weatherIcon);
        todaysDate = (TextView)findViewById(R.id.weatherDate);
        temperature = (TextView)findViewById(R.id.currentTemp);
        lowTemperature = (TextView)findViewById(R.id.lowTemp);
        location = (TextView)findViewById(R.id.cityCountry);
        ...
        if (reports.size() > 0) {
            ...
            switch (report.getWeather()) {
                case DailyWeatherReport.WEATHER_TYPE_CLEAR:
                    weatherImgBig.setImageDrawable(getResources().getDrawable(R.drawable.sunny));
                    break;
                case DailyWeatherReport.WEATHER_TYPE_CLOUDS:
                    weatherImgBig.setImageDrawable(getResources().getDrawable(R.drawable.cloudy));
                    break;
                case DailyWeatherReport.WEATHER_TYPE_RAIN:
                    weatherImgBig.setImageDrawable(getResources().getDrawable(R.drawable.rainy));
                    break;
                default:
                    weatherImgBig.setImageDrawable(getResources().getDrawable(R.drawable.sunny));
            }
            ...
            todaysDate.setText(report.getDateString());
            temperature.setText(Integer.toString(report.getMaxTemp()));
            lowTemperature.setText(Integer.toString(report.getMinTemp()));
            location.setText(report.getCityName() + ", " + report.getCountry());
        }
    }
    ...
    public void downloadWeatherData(@NonNull Location location) {
        ...
        String apiKey = "&APPID=c919f151e76da4cef20f1ef7a5cef975";
